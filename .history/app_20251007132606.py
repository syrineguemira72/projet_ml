...
def load_all_models():
    try:
        ...
        model_productivite = joblib.load('models/modele_productivite_ameliore.pkl')
        preprocesseurs = joblib.load('models/preprocesseurs_ameliore.pkl')
...
with st.expander("ℹ️ Guide d'Utilisation"):
    ...
    **🏭 Modèle Productivité** : Prédire la productivité réelle des équipes de production
...
st.caption("Système Multi-Modèles ML • Développé avec Groupe 6")